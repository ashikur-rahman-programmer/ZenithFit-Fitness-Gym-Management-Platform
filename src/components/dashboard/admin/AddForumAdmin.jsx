...
export default function AddForumAdmin({ user }) {
    ...
    >
      ...
      >
        ...
        <div>
          ...
          <div className="relative">
            ...
            <input
              ...
              type="file"
              accept="image/*"
              className={`${inputClass} file:bg-blue-600 file:border-none file:text-white file:rounded-lg file:py-1 file:px-2 cursor-pointer`}
            />
          </div>
        </div>
        ...
        <button
          ...
          type="submit"
          className="w-full bg-white text-black font-bold py-3.5 rounded-xl hover:bg-blue-600 hover:text-white transition-all flex items-center justify-center gap-2 disabled:opacity-50"
        >
          {isSubmitting ? (
            <>
