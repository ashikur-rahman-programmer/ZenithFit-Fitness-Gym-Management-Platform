    ...
    >
      ...
      {isModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 p-4">
          <div className="bg-[#111111] p-8 rounded-3xl w-full max-w-md border border-white/10">
            ...
            <textarea
              ...
              className="w-full bg-white/5 p-3 rounded-xl mb-4 border border-white/10"
            ...
            <div className="flex gap-4">
              <button
                ...
                className="flex-1 flex justify-center gap-2 py-3 bg-green-600 rounded-xl font-bold"
              >
                <CheckCircle size={18} /> Approve
              </button>
              <button
                onClick={() => handleAction("Rejected")}
                className="flex-1 flex justify-center gap-2 py-3 bg-red-600 rounded-xl font-bold"
              >
            ...
            <button
              ...
              className="mt-4 w-full text-white/50 text-sm"
            >
              Cancel
            </button>
          </div>
